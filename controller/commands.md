#### Usage:
Base: python3 x8_run.py
RC Overrride: python3 x8_run.py --rc
Test Case Selection: python3 x8_run.py --test chirp
  (see X8_Sequencer.py for options)
Particular Connection: python3 x8_run.py --connect tcp:127.0.0.1:5762
